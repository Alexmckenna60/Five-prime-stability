...
ggplot(long, aes(codon, GC, colour = Species)) + geom_point(show.legend = FALSE) + labs(x="Codon",y="GC content (%)",title="")+ scale_y_continuous(limits = c(0.15, 0.8),expand = c(0, 0))
